					...
					for (int current_plus = 0; current_plus < num_piplus; current_plus++) {
						for (int current_minus = 0; current_minus < num_piminus; current_minus++) {
							...
							if (dihadronVars.channel_test(dihadronVars)) {
								...
								// particle kinematics
								double elec_p = dihadronVars.elec_p();
								double piplus_p = dihadronVars.piplus_p();
								double piminus_p = dihadronVars.piminus_p();
								...
								System.out.printf(", %.2f, %.2f, %.2f, ", elec_p, piplus_p, 
									piminus_p)
